...
class MyContactCallback : public physx::PxSimulationEventCallback, public physx::PxContactModifyCallback
{
	std::vector<physx::PxRigidDynamic*> toSlowDownList;
public:
	MyContactCallback() = default;
